 ...
 * @author hastings
 */
public abstract class AbstractGeoserverClientSynchronizer {
	private static final Logger LOGGER = Logging.getLogger(AbstractGeoserverClientSynchronizer.class.getName());
	 ...
	 * @param postTemplate 
	 */
	public AbstractGeoserverClientSynchronizer(String url, String postTemplate) {
...
//	}
    ...
    protected Object parseWfs(InputStream is) throws IOException {
		long s = System.currentTimeMillis();
		try {
		    return doParseWfs(is);
		} finally {
	...
	protected abstract Object doParseWfs(InputStream is) throws IOException;
